...
YuuState does **not provide** a dedicated "_infinite query_" API for infinite scroll UI.\
...
<Callout type='info'>
Demo: https://afiiif.github.io/yuustate/async/yuustate/?activeTab=Infinite+Query
</Callout>
