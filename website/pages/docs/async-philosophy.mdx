...
YuuState provides a powerful async state layer, inspired by [TanStack Query](https://tanstack.com/query) but with a simpler API.
...
YuuState handles this state modeling so your UI stays predictable.
...
Because mutations are **not safe to repeat blindly**, YuuState does **not** include:
