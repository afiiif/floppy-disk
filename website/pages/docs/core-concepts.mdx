...
YuuState is built on two core ideas:
...
In YuuState, the store state is always an **object**.
...
YuuState follows the same pattern as React:
...
This is where YuuState becomes powerful.\
When you use the store inside React, YuuState internally:
